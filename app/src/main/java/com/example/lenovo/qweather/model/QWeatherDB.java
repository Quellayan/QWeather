package com.example.lenovo.qweather.model;
...
public class QWeatherDB {
    ...
    private static QWeatherDB qWeatherDB;
    private SQLiteDatabase db;

    private QWeatherDB(Context context){
        DBOpenHelper dbOpenHelper=new DBOpenHelper(context,dbName,null,VERSION);
        db= dbOpenHelper.getWritableDatabase();
    }
    public synchronized static QWeatherDB getInstance(Context context){
        if (qWeatherDB==null){
            qWeatherDB=new QWeatherDB(context);
        }
        return qWeatherDB;
    }
